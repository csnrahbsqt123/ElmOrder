...
class ShopSellerModel(BaseModel):
    __tablename__ = "shop_seller"
    # 店铺外部ID
    ...
    # 店铺和商家的关系
    seller_id = db.Column(db.Integer, db.ForeignKey('client.id'))
    # 建立反向查询关系
    seller = db.relationship("ClientUserModel", backref="shop_seller")
